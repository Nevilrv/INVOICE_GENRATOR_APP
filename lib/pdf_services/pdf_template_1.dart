...
import 'package:invoice_generator/pdf_services/pdf_services.dart';
...
class PdfTemplate1 {
  static Future<File> generate(Invoice invoice) async {
    ...
    return PdfServices.saveDocument(name: 'my_invoice.pdf', pdf: pdf);
  }
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                buildText(
                  title: 'CGST ${vatPercent * 100 / 2} %',
                  value: Utils.formatPrice(vat),
                  unite: true,
                ),
                buildText(
                  title: 'SGST ${vatPercent * 100 / 2} %',
                  value: Utils.formatPrice(vat),
                  unite: true,
                ),
                Divider(),
